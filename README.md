...
fix taxonomies... literaly.. otherwise you drop in the euclid´s problem.
...
but let go a little bit far... define and filter the payload transfer since is a "context payload"..
